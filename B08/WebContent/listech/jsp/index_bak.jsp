...
<head>
    ...
    <script type="text/javascript" src="./listech/js/jquery-1.11.2.min.js"></script>
			...
			<form method = "POST" action="adduser">
				...
				<div id = "follow">
					...
					<% for(int i = 0; i < t.followList.size(); i++){ %>
						<input type = "checkbox"
								 id = "following_<%out.print(i);%>"
							   name = "test"
							  value = <% out.print(t.followList.get(i).getScreenName());%>
						>
				...
				<div id = "follower">
					...
					<% for(int i = 0; i < t.followerList.size(); i++){ %>
						<input type = "checkbox"　id = "follower_<%out.print(i);%>" name = "test" value = <% out.print(t.followerList.get(i).getScreenName());%>>
				...
				<div id = "relationship">
					...
					<% for(int i = 0; i < t.relationshipList.size(); i++){ %>
						<input type = "checkbox" id = "relationship_<%out.print(i);%>" name = "test" value = <% out.print(t.relationshipList.get(i).getScreenName());%>>
